...
export const Contact = (props) => {
  ...
  return (
    <>
      <Navbar user={user} />
      <div className="font-light text-sm leading-8 h-full m-10 flex flex-col items-start justify-center sm:px-10 sm:py-5git sm:flex-row md:h-90vh md:pt-15 md:px-10 md:justify-start">
